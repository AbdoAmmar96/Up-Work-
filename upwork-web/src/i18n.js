...
const resources = {
  ar: {
    translation: {
      ...
      cta: { start: 'ابدأ مشروعك', profile: 'الملف التعريفي', see_work: 'شاهد أعمالنا', contact: 'تواصل معنا', send: 'إرسال الرسالة', view_project: 'تفاصيل المشروع', view_all: 'كل المشاريع', back: 'رجوع', watch: 'مشاهدة', explore: 'استكشف' },
      filter: { all: 'الكل' },
      ...
      contact_title: 'عندك مشروع؟ هيا بنا',
  ...
  en: {
    translation: {
      ...
      cta: { start: 'Start your project', profile: 'Company profile', see_work: 'See our work', contact: 'Contact us', send: 'Send message', view_project: 'View project', view_all: 'All projects', back: 'Back', watch: 'Watch', explore: 'Explore' },
      filter: { all: 'All' },
